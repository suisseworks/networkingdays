 ...
 * @property integer $idnw_categoria
...
class Categoria extends CActiveRecord
{
	...
	public function search()
	{
        ...
        $criteria->compare('idnw_categoria',$this->idnw_categoria,true);
    ...
    public static function getCategoria($idcategoria)
    {
        ...
        $categoria = parent::model(__CLASS__)->find(array('select'=>'nombre','condition'=>"idnw_categoria = $idcategoria"));
