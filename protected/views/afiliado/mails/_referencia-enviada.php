...
<title>Referencia Enviada</title>
							...
							<table border="0" cellpadding="0" cellspacing="0" width="100%">
								<tr>
									<td style="color: #153643; font-family: Arial, sans-serif; font-size: 24px;">
										<b>Has enviado una referencia</b>									</td>
								</tr>
								<tr>
								    ...
								    <p>Este correo es sólo para recordarte que has hecho una Recomendación de la Categoría
                                        <strong><?php echo $categoria ?></strong>  y Especialidad <strong><?php echo $especialidad ?></strong> .                                   
                                    <p>Referiste a <strong><?php echo $referido ?></strong> para que contacte a <strong><?php echo $interesado ?></strong>.</p>
                                    <p><br />
                                      Gracias por tu apoyo a los Círculos!</p>
                                    <p>Cordialmente,</p>
                                    <p>La Gente de Networking Days</p></td>
								</tr>
								<tr>
									<td>&nbsp;</td>
								</tr>
