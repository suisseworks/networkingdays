							...
							<table border="0" cellpadding="0" cellspacing="0" width="100%">
								<tr>
									<td style="color: #153643; font-family: Arial, sans-serif; font-size: 24px;">
										<b>Tu interés ha sido comunicado!</b>								</td>
								</tr>
								<tr>
								    ...
								    <p>Este correo es para comunicarte que <strong><?php echo $referidor ?></strong> te ha referido con <strong><?php echo $referido ?></strong> en la Categoría  <strong><?php echo $categoria ?></strong> y Especialidad <strong><?php echo $especialidad ?></strong><strong>
								...
								<tr>
									<td>
										<table border="0" cellpadding="0" cellspacing="0" width="100%">
                                            <tr>
                                              <td style="padding: 5px 0 0 0; color: #153643; font-family: Arial, sans-serif; font-size: 14px; line-height: 20px;">
                                                 <p>Los datos del Especialista son:</p>
                                                <p><strong>Nombre:</strong> <?php echo $referido ?> </p>
                                            ...
                                            <tr>
                                           <td width="540" style="padding: 25px 0 0 0; color: #153643; font-family: Arial, sans-serif; font-size: 14px; line-height: 20px;">
